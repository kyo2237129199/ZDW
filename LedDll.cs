...
//*****************************************************************************
         ...
         *				GrayLevel		灰度等级  赋值  0-5对应的灰度等级分别为 1,2,4,8,16,32
        ...
        public static extern int LV_CreateProgram(int LedWidth,int LedHeight,int ColorType,int GrayLevel,int SaveType);
